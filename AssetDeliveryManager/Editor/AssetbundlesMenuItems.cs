...
namespace AssetDelivery
{
    public class AssetBundlesMenuItems
    {
        ...
        {
            AssetManager.SimulateAssetDeliveryInEditor = !AssetManager.SimulateAssetDeliveryInEditor;
        }

        [MenuItem(kSimulationMode, true)]
        public static bool ToggleSimulationModeValidate()
        {
            Menu.SetChecked(kSimulationMode, AssetManager.SimulateAssetDeliveryInEditor);
            return true;
        }
