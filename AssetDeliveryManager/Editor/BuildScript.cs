...
namespace AssetDelivery
{
    public class BuildScript
    {
        ...
        static public string CreateAssetBundleDirectory()
        {
            ...
            string outputPath = Path.Combine(Utility.AssetBundlesOutputPath, Utility.PlatformName);
        ...
        public static void BuildPlayer(string outputPath = null)
        {
            if (outputPath == null)
            ...
            if (targetName == null)
                return;
            targetName = "/" + Application.productName + targetName; 
...
//            WriteServerURL();
        ...
        static void CopyAssetBundlesTo(string outputPath)
        {
            ...
            string outputFolder = Utility.PlatformName;
        ...
        {
            var relativeAssetBundlesOutputPathForPlatform = Path.Combine(Utility.AssetBundlesOutputPath, Utility.PlatformName);
            return Path.Combine(relativeAssetBundlesOutputPathForPlatform,  Utility.PlatformName) + ".manifest";
        }
    }
}
